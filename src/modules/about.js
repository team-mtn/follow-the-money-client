      ...
      <React.Fragment>
        ...
        <main className="about no-background">
          ...
          <section className="half-section">
            ...
            <article>
              <img src="../images/cool-cats.jpg" alt="I am the Walrus. Coo-Coo-Ca-Chew" />
            ...
            <article>
              <img src="../images/dog-gone.jpg" alt="I am the Walrus. Coo-Coo-Ca-Chew" />
              <p>Nhu "I'll Cut You!" Trinh a top level graduate of the general assembly bootcamp learned how to survive in the code with twin balisongs. She has turned her raw talent into a formidable career cutting up code and serving it with some fava beans and a nice chianti..</p>
            </article>
            <article>
              <img src="../images/i-am-the-walrus.jpg" alt="I am the Walrus. Coo-Coo-Ca-Chew" />
